...
I am building practical experience with Python, JavaScript/TypeScript, Git/GitHub,
APIs, tests, and technical documentation. I prefer a bounded bug fix, test fix,
or documentation/configuration change that I can reproduce and explain in a few
hours. I want to avoid umbrella projects, large refactors, unresolved product or
architecture decisions, and work that depends on deep infrastructure expertise.
For live ranking, I prefer an accepted issue with no visible assignee, open PR,
or student claim comments so I can start with a clean handoff.
